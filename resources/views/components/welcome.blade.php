...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900">
                <a href="https://laravel.com/docs">Ver Academias</a>
            </h2>
        </div>
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900">
                <a href="https://laracasts.com">Ver Cursos</a>
            </h2>
        </div>
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900">
                <a href="https://laravel.com/docs">Agregar Estudiante</a>
            </h2>
        </div>
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900">
                <a href="https://laracasts.com">Inscribir Estudiante</a>
            </h2>
        </div>

        <p class="mt-4 text-sm">
            <a href="https://laracasts.com" class="inline-flex items-center font-semibold text-indigo-700">
                Haz click aqui para inscribir un Estudiante a un Curso
